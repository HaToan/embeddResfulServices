...
namespace Mongoose
{
    class Sessions: public AbstractRequestCoprocessor
    {
        public:
            ...
            std::string getReqId(const std::shared_ptr<Request> &request, const std::shared_ptr<Response> &response);
            ...
            bool isExits(const std::shared_ptr<Request> &request, const std::shared_ptr<Response> &response);
